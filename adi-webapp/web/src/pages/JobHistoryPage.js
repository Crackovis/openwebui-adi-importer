...
export const JobHistoryPage = () => {
    ...
    return (_jsxs("section", { className: "page", children: [_jsxs("div", { className: "panel", children: [_jsx("h2", { children: "Job History" }), _jsx("p", { children: "Filter by state, source, or mode to locate specific import runs." })] }), _jsxs("div", { className: "panel form-grid", children: [_jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "status", children: "Status" }), _jsxs("select", { id: "status", value: filters.status, onChange: (event) => setFilters((current) => ({
                                ...
                                })), children: [_jsx("option", { value: "", children: "All" }), _jsx("option", { value: "chatgpt", children: "chatgpt" }), _jsx("option", { value: "claude", children: "claude" }), _jsx("option", { value: "grok", children: "grok" }), _jsx("option", { value: "aistudio", children: "aistudio" })] })] }), _jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "mode", children: "Mode" }), _jsxs("select", { id: "mode", value: filters.mode, onChange: (event) => setFilters((current) => ({
                                    ...current,
                                    mode: event.target.value,
                                })), children: [_jsx("option", { value: "", children: "All" }), _jsx("option", { value: "sql", children: "sql" }), _jsx("option", { value: "direct_db", children: "direct_db" })] })] })] }), error ? _jsx("div", { className: "panel error-text", children: error }) : null, _jsx("div", { className: "panel table-wrap", children: _jsxs("table", { children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Job" }), _jsx("th", { children: "Created" }), _jsx("th", { children: "Source" }), _jsx("th", { children: "Mode" }), _jsx("th", { children: "Status" }), _jsx("th", { children: "Action" })] }) }), _jsxs("tbody", { children: [jobs.map((job) => (_jsxs("tr", { children: [_jsx("td", { children: job.id.slice(0, 8) }), _jsx("td", { children: formatTimestamp(job.createdAt) }), _jsx("td", { children: job.source }), _jsx("td", { children: job.mode }), _jsx("td", { children: _jsx("span", { className: job.status.startsWith("failed_") ? "chip fail" : "chip", children: job.status }) }), _jsx("td", { children: _jsx(Link, { to: `/jobs/${job.id}`, children: "Open" }) })] }, job.id))), jobs.length === 0 ? (_jsx("tr", { children: _jsx("td", { colSpan: 6, children: "No jobs match current filters." }) })) : null] })] }) })] }));
};
